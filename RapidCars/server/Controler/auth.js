  ...
  Car.findOne({ carno: carno })
    .then((car) => {
      if (car) {
        ...
        return res
          .status(422)
          .json({ errors: [{ car: "car number already exists" }] });
      } else {
        const car = new Car({
          cname: cname,
          location: location,
...
function send_booking_mail(userid, carid, booking) {
  get_email_data(userid, carid).then((car) => {
    ...
    var date =
      String(booking.fromdate).slice(0, 24) +
      " To " +
      String(booking.todate).slice(0, 24);
    var location =
      String(booking.fromlocation).toUpperCase() +
      " To " +
      String(booking.tolocation).toUpperCase();
    var mail =
      '<h1 style="color:DodgerBlue;font-family: Lucida Sans Unicode;"> Booking Confirmed </h1><p style="font-family: Lucida Sans Unicode; font-size:150%;  "><b>' +
      car.uname +
      '</b> Thanks for booking car  .You will find the booking details and payment details below.</p><p style="font-family: Lucida Sans Unicode; font-size:150%; margin-top:0px; margin-bottom:0px;">Booking confirmed of <b>' +
      carname +
      '</b> </p> <p style="font-family: Lucida Sans Unicode; font-size:140%; margin-top:0px; margin-bottom:0px;"><b>' +
      date +
      '</b></p> <p style="font-family: Lucida Sans Unicode; font-size:150%; margin-top:0px; margin-bottom:0px;"><b>' +
      location +
      '</b></p><p style="font-family: Lucida Sans Unicode; font-size:150%; margin-top:0px; margin-bottom:0px;">Your total amount to be paid is <b>' +
      booking.BillAmount +
      '</b></p><p style="font-family: Lucida Sans Unicode; font-size:150%; margin-top:0px; margin-bottom:0px;"> You have booked to <b>to date</b> for this much time (Days:Hours:Minutes) <b>' +
      booking.Hours +
      '</b> </p><p style="font-family: Lucida Sans Unicode; font-size:120;">If you have any doubts or problem you contact us via email or phone us directly.</p><p style="font-family: Lucida Sans Unicode; font-size:120%;">email:rapidcars123@gmail.com</p><p style="font-family: Lucida Sans Unicode; font-size:120%;">phone:1231231342</p><p style="font-family: Lucida Sans Unicode; font-size:120%;">If the car is not returned within the time given above additional charges will be applied</p><p style="font-family: Lucida Sans Unicode; font-size:120%;">Thanks again</p><p style="font-family: Lucida Sans Unicode; font-size:120%;">The team of Rapid Cars</p>';
    var transporter = nodemailer.createTransport({
      service: "gmail",
      secure: true,
      auth: {
...
exports.BookingComplete = (req, res) => {
  ...
  Booking.findOne({ _id: bookingid })
    .then((data) => {
      Booking.updateOne({ _id: data._id }, { $set: { IsRuning: false } }).then(
        (response) => {
          Car.updateOne({ _id: data.car_id }, { $set: { IsBook: false } }).then(
            (response) => {
              res.status(200).json({
                success: true,
